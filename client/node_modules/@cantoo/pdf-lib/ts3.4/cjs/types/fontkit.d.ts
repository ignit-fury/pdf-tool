...
export interface Fontkit {
     ...
     */
    create(buffer: Uint8Array, postscriptName?: string): Font | FontCollection | Promise<Font | FontCollection>;
}
...
export declare const asFont: (font: Font | FontCollection) => Font;
