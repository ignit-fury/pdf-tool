...
export declare const canBeConvertedToUint8Array: (input: any) => input is BinaryData;
export declare const toUint8Array: (input: BinaryData) => Uint8Array;
export declare const byteArrayToHexString: (array: Uint8Array) => string;
